...
ClassImp(RooDoubleCB_new);

RooDoubleCB_new::RooDoubleCB_new(const char *name, const char *title,
                        RooAbsReal& _m,
                        RooAbsReal& _m0,
                        RooAbsReal& _sigma,
                        RooAbsReal& _alpha1,
...
RooDoubleCB_new::RooDoubleCB_new(RooDoubleCB_new const &other, const char *name)
...
double RooDoubleCB_new::evaluate() const 
{
   return RooDoubleCB_new_evaluate(m, m0, sigma, alpha1, n1, alpha2, n2); 
}

void RooDoubleCB_new::doEval(RooFit::EvalContext &ctx) const 
{ 
   ...
   for (std::size_t i = 0; i < n; ++i) {
      ctx.output()[i] = RooDoubleCB_new_evaluate(mSpan.size() > 1 ? mSpan[i] : mSpan[0],
...
void RooDoubleCB_new::translate(RooFit::Detail::CodeSquashContext &ctx) const
{
   ctx.addResult(this, ctx.buildCall("RooDoubleCB_new_evaluate", m, m0, sigma, alpha1, n1, alpha2, n2));
}
