...
void FitMassModel(RooWorkspace &myws) {
  ...
  std::cout << "HEHO : " << numEntries << std::endl; // 25387 74300
  ...
  /*************************************/
  myws.factory(Form("pT1[%.0f]", 0.));
  myws.factory(Form("pT2[%.0f]", 1.));
  /*************************************/
  ...
  myws.factory(Form("mJPsi[%.4f,%.4f,%.4f]", 3.0972, 3.0, 3.2));
  myws.factory(Form("sigma[%.4f,%.4f,%.4f]", 0.0486, 0.01, 0.08));
  myws.factory(Form("n1[%.4f,%.4f,%.4f]", 50.2868, 0., 100.));
  myws.factory(Form("alpha1[%.4f,%.4f,%.4f]", 0.7534, 0.1, 2.));
  myws.factory(Form("n2[%.4f,%.4f,%.4f]", 30.0346, 0., 60.));
  myws.factory(Form("alpha2[%.4f,%.4f,%.4f]", 4.0705, 0.1, 6.));
  myws.factory(Form("lambdas[%.4f,%.4f,%.4f]", -1.2867, -4., 1.2));
